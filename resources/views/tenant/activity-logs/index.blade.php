...
<div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
        <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Riwayat semua aktivitas yang terjadi di sistem.</p>
    </div>
</div>

<div class="mt-6 bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
    <div class="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
        <form method="GET" action="{{ route('tenant.activity-logs.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
            ...
            <div class="sm:col-span-2 lg:col-span-5 flex items-center gap-2">
                ...
                <a href="{{ route('tenant.activity-logs.index') }}" class="inline-flex items-center gap-2 rounded-md bg-gray-100 dark:bg-gray-700 px-3 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-200 dark:hover:bg-gray-600">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <tr class="log-row" data-log-id="{{ $log->id }}">
                    ...
                    <td>
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-sm">
                                <div class="font-medium text-gray-900 dark:text-white">{{ $log->user?->name ?? 'Sistem' }}</div>
