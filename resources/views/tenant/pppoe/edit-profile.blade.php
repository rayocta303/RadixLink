...
@section('title', 'Edit Profil PPPoE')
@section('page-title', 'Edit Profil PPPoE')

@section('content')
<div class="max-w-4xl">
    <form action="{{ route('tenant.pppoe.update-profile', $profile->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="local_address" id="local_address" value="{{ old('local_address', $profile->local_address) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="remote_address" id="remote_address" value="{{ old('remote_address', $profile->remote_address) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm font-mono">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="dns_server" id="dns_server" value="{{ old('dns_server', $profile->dns_server) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm font-mono">
                        @error('dns_server')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
            <div class="p-6 space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" name="only_one" id="only_one" value="1" {{ old('only_one', $profile->only_one) ? 'checked' : '' }}
