...
@section('content')
<div class="max-w-4xl">
    <form action="{{ route('tenant.services.update', $service) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select name="type" id="type" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                            <option value="hotspot" {{ old('type', $service->type) == 'hotspot' ? 'selected' : '' }}>Hotspot</option>
                            <option value="pppoe" {{ old('type', $service->type) == 'pppoe' ? 'selected' : '' }}>PPPoE</option>
                            <option value="dhcp" {{ old('type', $service->type) == 'dhcp' ? 'selected' : '' }}>DHCP</option>
                            <option value="hybrid" {{ old('type', $service->type) == 'hybrid' ? 'selected' : '' }}>Hybrid</option>
                        </select>
                        @error('type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="2"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">{{ old('description', $service->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="validity" id="validity" value="{{ old('validity', $service->validity) }}" min="1" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                        @error('validity')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="validity_unit" id="validity_unit" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                            <option value="minutes" {{ old('validity_unit', $service->validity_unit) == 'minutes' ? 'selected' : '' }}>Menit</option>
                            <option value="hours" {{ old('validity_unit', $service->validity_unit) == 'hours' ? 'selected' : '' }}>Jam</option>
                            <option value="days" {{ old('validity_unit', $service->validity_unit) == 'days' ? 'selected' : '' }}>Hari</option>
                            <option value="months" {{ old('validity_unit', $service->validity_unit) == 'months' ? 'selected' : '' }}>Bulan</option>
                        </select>
                        @error('validity_unit')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="bandwidth_down" id="bandwidth_down" value="{{ old('bandwidth_down', $service->bandwidth_down) }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    ...
                    <div>
                        ...
                        <input type="text" name="bandwidth_up" id="bandwidth_up" value="{{ old('bandwidth_up', $service->bandwidth_up) }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        @php
                            $quotaGb = $service->quota_bytes ? round($service->quota_bytes / 1073741824, 2) : 0;
                        @endphp
                        <label for="quota_gb" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Kuota (GB)</label>
                        <input type="number" name="quota_gb" id="quota_gb" value="{{ old('quota_gb', $quotaGb) }}" min="0" step="0.01"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    ...
                    <div>
                        ...
                        <input type="number" name="simultaneous_use" id="simultaneous_use" value="{{ old('simultaneous_use', $service->simultaneous_use) }}" min="1" max="100"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" name="has_fup" id="has_fup" value="1" {{ old('has_fup', $service->has_fup) ? 'checked' : '' }}
                ...
                @php
                    $fupThresholdGb = $service->fup_threshold_bytes ? round($service->fup_threshold_bytes / 1073741824, 2) : 0;
                @endphp
                <div id="fupFields" class="space-y-4 {{ old('has_fup', $service->has_fup) ? '' : 'hidden' }}">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        <div>
                            ...
                            <input type="number" name="fup_threshold_gb" id="fup_threshold_gb" value="{{ old('fup_threshold_gb', $fupThresholdGb) }}" min="0" step="0.01"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="fup_bandwidth_down" class="block text-sm font-medium text-gray-700 dark:text-gray-300">FUP Download</label>
                            <input type="text" name="fup_bandwidth_down" id="fup_bandwidth_down" value="{{ old('fup_bandwidth_down', $service->fup_bandwidth_down) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                        ...
                        <div>
                            ...
                            <input type="text" name="fup_bandwidth_up" id="fup_bandwidth_up" value="{{ old('fup_bandwidth_up', $service->fup_bandwidth_up) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
            ...
            <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="router_name" id="router_name"
                            ...
                            @foreach($routers ?? [] as $router)
                                <option value="{{ $router->shortname ?? $router->name }}" {{ old('router_name', $service->router_name) == ($router->shortname ?? $router->name) ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="bandwidth_id" id="bandwidth_id"
                            ...
                            @foreach($bandwidths ?? [] as $bandwidth)
                                <option value="{{ $bandwidth->id }}" {{ old('bandwidth_id', $service->bandwidth_id) == $bandwidth->id ? 'selected' : '' }}>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select name="ip_pool_id" id="ip_pool_id"
                            ...
                            @foreach($ipPools ?? [] as $pool)
                                <option value="{{ $pool->id }}" {{ old('ip_pool_id', $service->ip_pool_id) == $pool->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="pool" id="pool" value="{{ old('pool', $service->pool) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                ...
                <div id="pppoeProfileSection" class="{{ old('type', $service->type) === 'pppoe' ? '' : 'hidden' }}">
                    ...
                    <select name="pppoe_profile_id" id="pppoe_profile_id"
                        ...
                        @foreach($pppoeProfiles ?? [] as $profile)
                            <option value="{{ $profile->id }}" {{ old('pppoe_profile_id', $service->pppoe_profile_id) == $profile->id ? 'selected' : '' }}>
                ...
                <div id="hotspotProfileSection" class="{{ old('type', $service->type) === 'hotspot' ? '' : 'hidden' }}">
                    ...
                    <select name="hotspot_profile_id" id="hotspot_profile_id"
                        ...
                        @foreach($hotspotProfiles ?? [] as $profile)
                            <option value="{{ $profile->id }}" {{ old('hotspot_profile_id', $service->hotspot_profile_id) == $profile->id ? 'selected' : '' }}>
                                {{ $profile->name }} ({{ $profile->profile_name }})
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="max_devices" id="max_devices" value="{{ old('max_devices', $service->max_devices) }}" min="1" max="100"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                    </div>
                    <div class="flex items-end pb-2">
                        <div class="flex items-center">
                            <input type="checkbox" name="can_share" id="can_share" value="1" {{ old('can_share', $service->can_share) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500">
                ...
                <div class="space-y-3">
                    <div class="flex items-center">
                        <input type="checkbox" name="prepaid" id="prepaid" value="1" {{ old('prepaid', $service->prepaid ?? true) ? 'checked' : '' }}
                            class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="enabled" id="enabled" value="1" {{ old('enabled', $service->enabled ?? true) ? 'checked' : '' }}
                            class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500">
