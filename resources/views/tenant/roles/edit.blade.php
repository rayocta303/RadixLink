            ...
            <form action="{{ route('tenant.roles.update', $role) }}" method="POST">
                ...
                <div class="space-y-6">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                                    <p>Role {{ ucfirst($role->name) }} adalah role sistem yang memiliki akses penuh. Mengubah permission role ini dapat mempengaruhi keamanan sistem.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="description" id="description" value="{{ old('description', $role->description) }}" placeholder="Deskripsi singkat tentang role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2">
                        @error('description')
