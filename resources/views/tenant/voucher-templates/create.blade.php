...
@section('title', 'Buat Template Voucher')
@section('page-title', 'Buat Template Voucher Baru')

@section('content')
<div class="max-w-6xl">
    <form action="{{ route('tenant.voucher-templates.store') }}" method="POST" id="templateForm">
        @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="2" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="paper_size" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2">
                                        ...
                                        <option value="{{ $value }}" {{ old('paper_size', 1) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <input type="number" name="vouchers_per_page" value="{{ old('vouchers_per_page', 6) }}" min="1" max="20" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2">
                            </div>
                            <div class="flex items-center space-x-6">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="show_logo" value="1" {{ old('show_logo', true) ? 'checked' : '' }}
                                        class="rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <textarea name="html_template" id="htmlTemplate" rows="15" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2 font-mono text-xs">{{ old('html_template', $defaultTemplate) }}</textarea>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <textarea name="css_styles" id="cssStyles" rows="12" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2 font-mono text-xs">{{ old('css_styles', $defaultCss) }}</textarea>
                    </div>
                </div>
            </div>
