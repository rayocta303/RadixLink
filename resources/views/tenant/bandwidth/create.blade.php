...
@section('title', 'Tambah Bandwidth')
@section('page-title', 'Tambah Profil Bandwidth Baru')

@section('content')
<div class="max-w-4xl">
    <form action="{{ route('tenant.bandwidth.store') }}" method="POST" class="space-y-6">
        @csrf
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="2"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                        placeholder="Catatan tentang profil bandwidth ini">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="rate_limit_upload" id="rate_limit_upload" value="{{ old('rate_limit_upload') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="rate_limit_download" id="rate_limit_download" value="{{ old('rate_limit_download') }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm font-mono"
                            placeholder="10M">
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="burst_limit_upload" id="burst_limit_upload" value="{{ old('burst_limit_upload') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm font-mono"
                            placeholder="10M">
                    ...
                    <div>
                        ...
                        <input type="text" name="burst_limit_download" id="burst_limit_download" value="{{ old('burst_limit_download') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm font-mono"
                            placeholder="20M">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="burst_threshold_upload" id="burst_threshold_upload" value="{{ old('burst_threshold_upload') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm font-mono"
                            placeholder="4M">
                    ...
                    <div>
                        ...
                        <input type="text" name="burst_threshold_download" id="burst_threshold_download" value="{{ old('burst_threshold_download') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm font-mono"
                            placeholder="8M">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="burst_time_upload" id="burst_time_upload" value="{{ old('burst_time_upload') }}" min="1" max="60"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                            placeholder="10">
                    ...
                    <div>
                        ...
                        <input type="number" name="burst_time_download" id="burst_time_download" value="{{ old('burst_time_download') }}" min="1" max="60"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                            placeholder="10">
                ...
                <div>
                    ...
                    <input type="number" name="priority" id="priority" value="{{ old('priority', 8) }}" min="1" max="8"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                        placeholder="8">
