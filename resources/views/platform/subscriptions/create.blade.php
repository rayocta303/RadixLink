                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <div id="features-container" class="mt-4 space-y-3">
                            <div class="feature-item flex items-center gap-2">
                                <input type="text" name="features[]" placeholder="Contoh: Free VPN Radius" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2">
