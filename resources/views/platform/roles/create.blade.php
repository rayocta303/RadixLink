...
@section('page-title', 'Tambah Role Platform')
            ...
            <form action="{{ route('platform.roles.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" required value="{{ old('name') }}" placeholder="Contoh: platform_viewer" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm px-3 py-2">
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Nama role akan secara otomatis diawali dengan "platform_" jika belum ada.</p>
                        @error('name')
